...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      sections={[
        { heading: "Agreement and changes", body: "By accessing this website or requesting our services, you agree to these terms. We may update them from time to time by posting a revised version on this page; continued use after changes means you accept the revised terms." },
