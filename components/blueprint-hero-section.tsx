...
export default function BlueprintHeroSection() {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
        ...
        <div
          className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center transition-all duration-2000 ${
  ...
  <Button className="bg-[#8B0000] hover:bg-[#DC2626] text-white px-8 sm:px-12 md:px-16 py-6 sm:py-8 text-base sm:text-lg md:text-xl font-mono tracking-widest border-2 border-[#8B0000] hover:border-[#C0C0C0] transition-all duration-500 hover:shadow-2xl hover:shadow-red-900/50 group relative overflow-hidden glitch w-full sm:w-auto text-center">
    <span className="relative z-10 whitespace-nowrap">[APPLY TO MANUFACTURE WITH US]</span>
    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24">
            ...
            <p className="text-2xl text-gray-400 max-w-4xl mx-auto italic font-light leading-relaxed">
              These aren't tips. They're a creed. If you've ever had to explain your obsession with production, you won't need to here.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {codes.map((code, index) => (
              <Card key={index} className="bg-black/70 border-[#C0C0C0]/30 hover:border-[#DC2626] transition-all duration-700 group industrial-shadow">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-lg font-bold text-white group-hover:text-[#DC2626] transition-colors duration-500 leading-tight">{code}</h3>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-32 bg-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24">
            <h2 className="text-5xl md:text-7xl font-black text-white mb-12 tracking-tight font-mono">THE NON-NEGOTIABLES</h2>
                  ...
                  <div className="group cursor-pointer" onClick={handleModalOpen}>
                    <div className="bg-gray-900/30 border-2 border-[#C0C0C0]/20 p-8 hover:border-[#DC2626] transition-all duration-500 hover:bg-[#DC2626]/10 industrial-shadow">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-[#C0C0C0] group-hover:text-[#DC2626] transition-colors duration-500">[CLICK]</div>
                      </div>
                    </div>
                  </div>
                </DialogTrigger>
  ...
  <div className="p-8 text-center">
    ...
    <p className="text-xl text-white leading-relaxed">{item.description}</p>
      ...
      <section className="py-32 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24">
            <h2 className="text-5xl md:text-7xl font-black text-white mb-12 tracking-tight font-mono">THE QUIET DOMINATORS</h2>
