  ...
  return (
    <footer className="bg-[#0a0a0a] border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col gap-4 md:flex-row md:justify-between text-sm"><p className="text-gray-400">© 2024 Custom Wear Industry. All rights reserved.</p><div className="flex gap-4"><Link href="/privacy-policy" className="text-gray-400 hover:text-white">Privacy</Link><Link href="/terms-and-conditions" className="text-gray-400 hover:text-white">Terms</Link><Link href="/returns-and-refunds" className="text-gray-400 hover:text-white">Returns</Link></div></div>
      </div>
    </footer>
  )
}
