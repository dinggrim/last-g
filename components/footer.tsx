    ...
    <footer className="bg-[#0a0a0a] border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div><h4 className="text-lg font-semibold text-white mb-4">Contact</h4><ul className="flex flex-col gap-3"><li><p className="text-gray-400 text-sm">Email</p><a href="mailto:info@customwearindustry.com" className="text-white hover:text-[#FF3C38]">info@customwearindustry.com</a></li><li><p className="text-gray-400 text-sm">Registered office</p><p className="text-white text-sm">{businessAddress}</p><a href="tel:+13075007462" className="mt-2 inline-block text-white hover:text-[#276EF1]">+1 3075007462</a></li></ul></div>
        </div>
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col gap-4 md:flex-row md:justify-between text-sm"><p className="text-gray-400">© 2024 Custom Wear Industry. All rights reserved.</p><div className="flex gap-4"><Link href="/privacy" className="text-gray-400 hover:text-white">Privacy Policy</Link><Link href="/terms" className="text-gray-400 hover:text-white">Terms &amp; Conditions</Link><Link href="/refund-policy" className="text-gray-400 hover:text-white">Refund Policy</Link></div></div>
      </div>
    </footer>
  )
}
